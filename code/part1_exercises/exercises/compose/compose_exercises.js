...
// could be replaced with _.prop('dollar_value')
...
var sanitizeName = _.compose(toLowerCase, _underscore, _.prop('name'));
var sanitizeNames = _.map(sanitizeName);


// Bonus 1:
// ============
// Refactor availablePrices with compose.
var formatMoney = _.compose(accounting.formatMoney, _.prop('dollar_value'));
var availablePrices = _.compose(_.join(', '), _.map(formatMoney), _.filter(_.prop('in_stock')));
...
var printFastest = _.curry(function(name){
